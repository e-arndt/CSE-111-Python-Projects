...
def main():
       ...
       welcome()
       print("[Example - Ethylene glycol = C2H6O2]")
       user_formula = (input("Please enter a chemical formula: ")).upper()
       print()
       ...
       print(f"Molar Mass of this compound: {molar_mass:.6f} grams/mole")
       print(f"Moles in this sample size  : {sample_moles:.6f} moles")
       print(new_line)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for item in list:
        ...
        #print(f"Symbol:{element_symbol} Name:{element_name} QTY:{element_atomic_qty} Mass:{element_atomic_mass} T Atomic:{total_atomic_mass} T Molar:{total_molar_mass}" )
        #print()
